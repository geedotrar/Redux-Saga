...
import CountriesCreateForm from "../Form/Countries/CountriesCreateForm";
import CountriesEditForm from "../Form/Countries/CountriesEditForm";
...
export default function CountriesViewApi() {
  ...
  return (
    <div>
      {displayEdit ? (
        <CountriesEditForm id={id} setRefresh={setRefresh} setDisplay={setDisplay} />
      ) : display ? (
